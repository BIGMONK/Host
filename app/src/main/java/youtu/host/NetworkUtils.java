...
public class NetworkUtils {
    ...
    public static boolean isNetworkAvailable(Context context) {
        ...
        NetworkInfo networkInfo = mConnMgr == null ? null : mConnMgr.getActiveNetworkInfo();  //
        // 获取活动网络连接信息
    ...
    public static void openWifi(Context context) throws Exception {
        WifiManager wifiManager = ((WifiManager) context.getSystemService(
                Context.WIFI_SERVICE));
    ...
    public static boolean isMACString(String mac) {
