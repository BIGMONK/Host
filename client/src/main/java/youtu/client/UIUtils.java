...
public class UIUtils {
	...
	public static Context getContext(){
		return ApplicationClient.getmContext();
	}
	...
	public static Handler getHandler(){
		return ApplicationClient.getmHandler();
	}
	...
	public static Thread getMainThread(){
		return ApplicationClient.getmMainThread();
	}
	...
	public static int getMainThreadId(){
		return ApplicationClient.getmMainThreadId();
	}
